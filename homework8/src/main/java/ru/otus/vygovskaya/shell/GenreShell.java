...
public class GenreShell {
    ...
    public String getGenre(String id){
        try {
            ...
            return getGenreInfo(genre).orElse("don't get entity");
        } catch (DataAccessException e){
    ...
    public String updateGenre(String id, @ShellOption(defaultValue = "tale") String name){
        try {
    ...
    public String getAllGenres(){
        try {
            ...
            all.stream().forEach(genre -> sb.append(getGenreInfo(genre.getId(), genre.getName())).append("\n"));
            return sb.toString();
        } catch (DataAccessException e){
    ...
    private static String getGenreInfo(String id, String name){
        StringBuilder sb = new StringBuilder();
