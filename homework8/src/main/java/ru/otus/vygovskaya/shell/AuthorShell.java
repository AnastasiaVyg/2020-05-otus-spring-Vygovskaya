...
public class AuthorShell {
    ...
    public String getAuthor(String id){
        try {
            ...
            return getAuthorInfo(author).orElse("don't get entity");
        } catch (DataAccessException e){
    ...
    public String updateAuthor(String id, @ShellOption(defaultValue = "J") String name, @ShellOption(defaultValue = "Aust") String surname){
        try {
    ...
    private static String getAuthorInfo(String id, String name, String surname){
        StringBuilder sb = new StringBuilder();
